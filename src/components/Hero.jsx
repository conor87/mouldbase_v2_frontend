    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center pt-16 sm:pt-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
            ...
            <div className='max-w-7xl mx-auto text-center relative w-full'>
                <div className='max-ww-7xl mx-auto flex flex-col lg:grid lg:grid-cols-2 text-center lg:text-left gap-6 sm:gap-8 lg:gap-12 items-center relative'>
                    <div>
                        <div className='inline-flex items-center space-x-2 p-3 sm:px-4 bg-blue-500/10 border border-blue-500/20 rounded-full mb-4 sm:mb-6 animate-in slide-in-from-bottom duration-700'>
                        ...
                        <h1 className='text-5xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-semibold mb-4 sm:mb-6 animate-in slide-in-from-bottom duration-700 delay-100 leading-tight'>
                            <span className='text-gray-200 block mb-1 sm:mb-2'>
                                Code Faster
                            </span>
                            <span className='text-blue-400 block mb-1 sm:mb-2'>
                                Build better
                            </span>
                            <span className='text-gray-200 block mb-1 sm:mb-2'>
                                With CodeFlow AI
                        ...
                        <p className='text-md sm:text-base lg:text-lg text-gray-400 max-w-2xl mx-auto mb-6 sm:mb-8 animate-in slide-in-from-bottom duration-700 delay-200 leading-relaxed'>
                        ...
                        <button className='group w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg font-semibold text-sm sm:text-base transition-all duration-300 hover:bg-white/10 flex items-center justify-center space-x-2'>
                            <div className='p-2 bg-white/10 rounded-full group-hover:bg-white/20 duration-300 transition-colors'>
                                <Play className='w-4 h-4 sm:h-5 fill-blue-400'/>
                            </div>
                        ...
                        <div className="relative bg-white/5 backdrop-blur-xl rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-2xl border border-white/10">
                            <div className="bg-linear-to-br from-gray-900/20 to-gray-800/20 backdrop-blur-sm rounded-lg overflow-hidden h-[280px] sm:h-[350px] lg:h-[450px] border border-white/5">
                                ...
                                <div className="flex items-center justify-between px-3 sm:px-4 py-2 sm:py-3 bg-white/5 backdrop-blur-sm border-b border-white/10">
                                    <div className='flex items-center space-x-2'>
                                        ...
                                        <span className='text-xs sm:text-sm text-grey-300'>ToolShop 2.0</span>
                                    </div>
                                ...
                                <div className='p-3 sm:p-4 relative h-full'>
                                    {/* FILE TABS */}
                                    <div 
                                    className='flex space-x-1 sm:space-x-2 mb-3 sm:mb-4 overflow-auto'>
                                        <button onClick={()=>setActiveTab("App.jsx")}
                                        className = {`px-3 py-2 backdrop-blur-sm text-sm sm:text-sm rounded-t-lg border ${
                                            activeTab === "App.jsx"
                                            ? "bg-blue-500/30 text-white border-blue-400/20" 
                                            : "bg-white/5 text-grey-300 border-white/10 hover:bg-white/10"
                                    ...
                                    {/* CODE AREA */}
                                    <div className='relative overflow-hidden flex-grow'></div>
                            ...
                            <div className={`hidden lg:block absolute bottom-4 right-4 transform translate-x-8 translate-y-8 w-72 ${currentFloatingCard.bgColor} backdrop-blur-xl rounded-lg p-4 border border-white/10 shadow-2xl`}>
                                <div className='flex items-center space-x-2 mb-2'>
                                    <div className={`w-6 h-6 ${currentFloatingCard.icon} flex items-center justify-center text-sm font-bold`}>{currentFloatingCard.icon}</div>
